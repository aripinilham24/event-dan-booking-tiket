    ...
    <html lang="id">
        <head>
            ...
            <title>Home | Booking Tiket Event Terpercaya</title>
            <!-- Favicon-->
        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-lg-5">
                    <a class="navbar-brand" href="#!">BooQit</a>
                ...
                <div class="container px-lg-5">
                    <div class="p-4 p-lg-5 bg-light rounded-3 text-center">
                        <div class="m-4 m-lg-5">
                            <h1 class="display-6 fw-bold">Temukan & Pesan Tiket Event Favoritmu!</h1>
                            <p class="fs-5">Temukan berbagai event seru yang sedang berlangsung dan pesan tiketmu dengan mudah. Dari konser musik, festival seni, seminar inspiratif, hingga acara komunitas – semuanya ada di satu tempat. Proses pemesanan yang cepat dan aman memastikan kamu bisa fokus menikmati setiap momen tanpa khawatir kehabisan tiket. Ayo, temukan event favoritmu dan jadikan setiap momen lebih berarti!</p>
